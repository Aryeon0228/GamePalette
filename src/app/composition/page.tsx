...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = ko
    ? "물건의 크기·간격·방향·겹침을 바꾸며 구도를 실험하고, 이미지의 실루엣과 여백을 비교하세요."
    : "Explore composition through size, spacing, direction and overlap, then compare silhouettes and negative space in your own images."
  return {
    title,
    description,
